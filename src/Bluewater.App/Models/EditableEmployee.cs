...
public partial class EditableEmployee : ObservableObject
{
  ...
  public string? UserIdText
  {
    ...
    set
    {
      if (SetProperty(ref userIdText, value))
      {
        UserId = ParseGuidOrNull(value);
      }
    }
  }
  ...
  public string? PositionIdText
  {
    ...
    set
    {
      if (SetProperty(ref positionIdText, value))
      {
        PositionId = ParseGuidOrNull(value);
      }
    }
  }

  private string? payIdText;
  public string? PayIdText
  {
    get => payIdText;
    set
    {
      if (SetProperty(ref payIdText, value))
      {
        PayId = ParseGuidOrNull(value);
      }
    }
  }
  ...
  public string? TypeIdText
  {
    ...
    set
    {
      if (SetProperty(ref typeIdText, value))
      {
        TypeId = ParseGuidOrNull(value);
      }
    }
  }
  ...
  public string? LevelIdText
  {
    ...
    set
    {
      if (SetProperty(ref levelIdText, value))
      {
        LevelId = ParseGuidOrNull(value);
      }
    }
  }

  private string? chargingIdText;
  public string? ChargingIdText
  {
    get => chargingIdText;
    set
    {
      if (SetProperty(ref chargingIdText, value))
      {
        ChargingId = ParseGuidOrNull(value);
      }
    }
  }

  private EmployeeExternalOption? selectedPositionOption;
  public EmployeeExternalOption? SelectedPositionOption
  {
    get => selectedPositionOption;
    set
    {
      if (SetProperty(ref selectedPositionOption, value))
      {
        Position = value is { IsPlaceholder: true } ? null : value?.Label;
        PositionId = value?.Id;
      }
    }
  }

  private EmployeeExternalOption? selectedTypeOption;
  public EmployeeExternalOption? SelectedTypeOption
  {
    ...
    set
    {
      ...
      {
        Type = value is { IsPlaceholder: true } ? null : value?.Label;
        TypeId = value?.Id;
      }
    }
  }

  private EmployeeExternalOption? selectedLevelOption;
  public EmployeeExternalOption? SelectedLevelOption
  {
    get => selectedLevelOption;
    set
    {
      if (SetProperty(ref selectedLevelOption, value))
      {
        Level = value is { IsPlaceholder: true } ? null : value?.Label;
        LevelId = value?.Id;
      }
    }
  }

  private EmployeeExternalOption? selectedChargingOption;
  public EmployeeExternalOption? SelectedChargingOption
  {
    get => selectedChargingOption;
    set
    {
      if (SetProperty(ref selectedChargingOption, value))
      {
        ChargingId = value?.Id;
      }
    }
  ...
  partial void OnUserIdChanged(Guid? value) => UpdateGuidText(value, ref userIdText, nameof(UserIdText));

  partial void OnPositionIdChanged(Guid? value) => UpdateGuidText(value, ref positionIdText, nameof(PositionIdText));

  partial void OnPayIdChanged(Guid? value) => UpdateGuidText(value, ref payIdText, nameof(PayIdText));

  partial void OnTypeIdChanged(Guid? value) => UpdateGuidText(value, ref typeIdText, nameof(TypeIdText));

  partial void OnLevelIdChanged(Guid? value) => UpdateGuidText(value, ref levelIdText, nameof(LevelIdText));

  partial void OnChargingIdChanged(Guid? value) => UpdateGuidText(value, ref chargingIdText, nameof(ChargingIdText));

  private void UpdateGuidText(Guid? value, ref string? field, string propertyName)
  {
